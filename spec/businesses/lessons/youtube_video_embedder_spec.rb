...
RSpec.describe Lessons::YoutubeVideoEmbedder, type: :lib do
  describe '.embed_url' do
    it 'returns the embedded YouTube video URL' do
      ...
      embedded_url = Lessons::YoutubeVideoEmbedder.embed_url(video_url)
    ...
    it 'handles different YouTube video URL formats' do
      ...
      embedded_url1 = Lessons::YoutubeVideoEmbedder.embed_url(video_url1)
      embedded_url2 = Lessons::YoutubeVideoEmbedder.embed_url(video_url2)
